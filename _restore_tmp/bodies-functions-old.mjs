...
function bodyReviewAi(exp, lang) {
  ...
  return `<section class="ld-section ld-live" id="live-experiment" data-ld-review>
...
function bodyQr(exp, lang) {
  ...
  return `<section class="ld-section ld-live" id="live-qr" data-ld-qr>
  <div class="ld-section__head">
...
function bodyForm(exp, lang) {
  ...
  return `<section class="ld-section ld-live" id="form-builder" data-ld-form data-lang="${escapeHtml(lang)}">
  <div class="ld-section__head">
...
function bodyAi(exp, lang) {
  ...
  return `<section class="ld-section" id="discovery-pipeline">
...
function bodyGame(exp, lang) {
  ...
  return `<section class="ld-section ld-cinema" id="the-experiment" data-ld-game>
