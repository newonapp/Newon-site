...
export const STUDIO_STATUS_LABEL = {
  ...
  EXPERIMENTAL: { ko: "Experimental", en: "Experimental" },
    ...
    items: [
      {
        title: "Character Lab",
        titleKo: "캐릭터 랩",
        desc: "캐릭터 콘셉트와 비주얼 방향을 빠르게 실험합니다.",
        descEn: "Quick experiments in character concept and visual direction.",
      ...
      },
      {
        ...
        titleKo: "디지털 스티커",
        desc: "캐릭터 감정을 디지털 표현으로 확장. 현재 준비 중.",
      ...
      },
      {
        ...
        titleKo: "Newon 캐릭터",
        desc: "Newon 자체 브랜드용 캐릭터 IP 내부 프로젝트.",
        descEn: "Internal Newon brand character IP project.",
        href: null,
        status: "BUILDING",
      },
      {
        ...
        titleKo: "실험 IP",
        desc: "새로운 IP 형태를 실험하는 탐색 영역.",
        descEn: "An exploration area for new IP forms.",
        href: null,
        status: "EXPLORING",
      },
    ],
