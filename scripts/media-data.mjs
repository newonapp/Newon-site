...
export const MEDIA_ITEMS_HUB = [
  ...
  },
  {
    ...
    category: "PRODUCT",
    igType: "POST",
    titleKo: "아홉 번째 앱은 BabyLog — 육아 기록부터 가족 생활까지",
    titleEn: "Ninth up: BabyLog — from care logs to family life",
    descriptionKo: "수유·수면·기저귀 기록, AI 분석, 가족 공유, 일정·사진·육아용품까지 한곳에서.",
    descriptionEn: "Feeding, sleep, and diaper logs plus AI insights, family sharing, schedules, photos, and baby gear.",
    date: "2026-09-13",
  ...
  },
  {
    ...
    category: "PRODUCT",
    igType: "POST",
    titleKo: "여덟 번째 앱은 GoalUp — 목표를 끝까지 이어가기",
    titleEn: "Eighth up: GoalUp — goals you follow through on",
    descriptionKo: "목표 설정, 오늘의 할 일, 챌린지와 성취 기록으로 작은 실천을 쌓아갑니다.",
    descriptionEn: "Set goals, check off today’s tasks, and build streaks with challenges that stick.",
    date: "2026-09-10",
  ...
  },
  {
    ...
    category: "PRODUCT",
    igType: "POST",
    titleKo: "일곱 번째 앱은 PiggyUp — 아낀 돈을 저축으로 기록",
    titleEn: "Seventh up: PiggyUp — turn skipped spends into savings",
    descriptionKo: "커피·배달·충동구매를 참은 금액을 기록하고, AI 절약 관리와 챌린지로 저축 습관을 만듭니다.",
    descriptionEn: "Log money you didn’t spend, get AI saving tips, and join challenges that make thrift feel rewarding.",
    date: "2026-09-09",
