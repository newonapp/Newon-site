...
export const STORE_DETAIL_UI = {
  ko: {
    ...
    purchaseFinalTitle: "이 키트를\n구매하시겠어요?",
    purchaseFinalLead:
      "구매 문의를 남겨 주시면 확인 후 DOCX·PDF 파일을 이메일로 전달합니다. 즉시 다운로드는 제공하지 않습니다.",
  },
  en: {
    ...
    licenseTitle: "Usage terms",
    deliveryEyebrow: "DELIVERY",
    deliveryTitle: "How you receive the files",
    faqEyebrow: "FAQ",
    ...
    heroPurchaseCta: "Purchase inquiry →",
    ...
    purchaseFinalTitle: "Ready to\npurchase this kit?",
    purchaseFinalLead:
      "Send a purchase inquiry. After confirmation, DOCX and PDF files are delivered by email. Instant download is not available.",
  },
};

/** @type {Record<string, object>} */
export const STORE_DETAILS = {
  "newon-project-starter-kit": {
    preview: "project-starter",
    categoryEyebrow: "STORE · BUSINESS DOCUMENTS",
    title: "NEWON Project Starter Kit",
    previewNameKo: "Project Document Kit Preview",
    previewNameEn: "Project Document Kit Preview",
    metaKo:
      "프로젝트 요구사항·견적·범위·계약 초안·납품 체크리스트 5종. DOCX·PDF. ₩19,000. Newon Digital Business Kit.",
    metaEn:
      "Five project documents: requirements, quotation, scope, contract draft, delivery checklist. DOCX + PDF. ₩19,000.",
    heroTitleKo: "프로젝트를 시작할 때\n필요한 실무 문서를 한 패키지로.",
    heroTitleEn: "The practical documents you need\nto start a project — in one kit.",
    heroLeadKo:
      "NEWON Project Starter Kit은\n프로젝트 시작에 필요한 5종의 실무 문서를\n하나의 Digital Business Kit으로 구성합니다.\n\n각 문서는 편집 가능한 DOCX와\n확인·공유용 PDF로 제공됩니다.",
    heroLeadEn:
      "NEWON Project Starter Kit packs five practical documents\ninto one Digital Business Kit for starting client work.\n\nEach document is delivered as editable DOCX\nand shareable PDF.",
    overviewTitleKo: "처음부터 끝까지\n문서 흐름을 맞춥니다.",
    overviewTitleEn: "Align the document flow\nfrom start to delivery.",
    overviewBodyKo: [
      "외주·클라이언트 프로젝트는 요구사항이 흐려지면\n견적과 범위, 납품 기준까지 흔들립니다.",
      "이 키트는 질문지 → 견적 → 범위 → 계약 초안 → 납품 체크까지\n같은 프로젝트 맥락으로 이어지도록 구성했습니다.",
      "법률 자문 서비스가 아닙니다.\n실무에서 바로 쓸 수 있는 문서 템플릿 패키지입니다.",
    ],
    overviewBodyEn: [
      "Client projects drift when requirements stay vague —\nand quotes, scope, and delivery criteria drift with them.",
      "This kit connects requirements → quotation → scope → contract draft → delivery checklist\nin one shared project context.",
      "It is not legal advice.\nIt is a practical document template pack for real project work.",
    ],
    whoTitleKo: "이런 사람과 팀에게 필요합니다.",
    whoTitleEn: "Who this kit is for.",
    whoKo: [
      { t: "프리랜서", d: "클라이언트 프로젝트를 문서부터 정리하고 싶을 때" },
      { t: "1인 개발자·디자이너", d: "견적·범위·납품 기준을 혼자 준비해야 할 때" },
      { t: "소규모 스튜디오", d: "팀 안팎으로 같은 문서 포맷을 쓰고 싶을 때" },
      { t: "초기 창업자", d: "외주·파트너 업무를 처음 시작할 때" },
      { t: "프로젝트 외주 시작자", d: "요구사항부터 납품까지 기본 골격을 원할 때" },
    ],
    whoEn: [
      { t: "Freelancers", d: "When you want client work structured from the documents up" },
      { t: "Solo developers & designers", d: "When you prepare quotes, scope, and delivery alone" },
      { t: "Small studios", d: "When the team needs a shared document format" },
      { t: "Early founders", d: "When starting contractor or partner work for the first time" },
      { t: "Anyone starting project work", d: "When you need a baseline from requirements to delivery" },
    ],
    whatTitleKo: "다섯 문서로\n프로젝트 시작을 구성합니다.",
    whatTitleEn: "Five documents\nto structure a project start.",
    whatKo: [
      { t: "Project Requirements", d: "요구사항 질문지로 무엇을 만들지 정리합니다." },
      { t: "Quotation", d: "견적서로 범위와 비용을 맞춰 봅니다." },
      { t: "Scope of Work", d: "범위서로 포함·제외를 분명히 합니다." },
      { t: "Contract Draft", d: "계약서 초안으로 기본 합의 골격을 잡습니다." },
      { t: "Delivery Checklist", d: "납품 체크리스트로 완료 기준을 확인합니다." },
    ],
    whatEn: [
      { t: "Project Requirements", d: "Clarify what to build with a requirements questionnaire." },
      { t: "Quotation", d: "Align scope and cost with a quotation sheet." },
      { t: "Scope of Work", d: "Make inclusions and exclusions explicit." },
      { t: "Contract Draft", d: "Draft a practical agreement outline." },
      { t: "Delivery Checklist", d: "Confirm completion criteria before handoff." },
    ],
    includesKo: [
      "프로젝트 요구사항 질문지",
      "프로젝트 견적서",
    ...
    outcomesTitleKo: "프로젝트 시작에\n필요한 문서 세트가 남습니다.",
    outcomesTitleEn: "You leave with a starter set\nof project documents.",
    outcomesKo: [
      { t: "요구사항 정리", d: "질문 기반으로 프로젝트 입력을 모읍니다." },
      { t: "견적·범위 정렬", d: "비용과 범위를 한 흐름으로 맞춥니다." },
      { t: "합의 초안", d: "계약서 초안으로 기본 조건을 적어 둡니다." },
      { t: "납품 기준", d: "체크리스트로 완료 여부를 확인합니다." },
    ],
    outcomesEn: [
      { t: "Requirements captured", d: "Collect project inputs through structured questions." },
      { t: "Quote & scope aligned", d: "Keep cost and scope in one continuous flow." },
      { t: "Agreement draft", d: "Record baseline terms in a contract draft." },
      { t: "Delivery criteria", d: "Check completion against a delivery list." },
    ],
    howToTitleKo: "이렇게 사용합니다.",
    howToTitleEn: "How to use it.",
    formatKo: ["DOCX", "PDF"],
    formatEn: ["DOCX", "PDF"],
    formatNoteKo: "각 문서는 편집 가능한 DOCX와 확인·공유용 PDF로 제공됩니다.",
    formatNoteEn: "Each document is provided as editable DOCX and shareable PDF.",
    licenseKo:
    ...
    howToKo: [
      {
        n: "01",
        title: "요구사항",
        body: "질문지를 채우며 프로젝트 입력을 모읍니다.",
      },
      {
        n: "02",
        title: "견적·범위",
        body: "견적서와 범위서로 포함 범위를 맞춥니다.",
      },
      {
        n: "03",
        title: "계약 초안",
        body: "합의가 필요할 때 초안을 수정해 사용합니다.",
      },
      {
        n: "04",
        title: "납품",
        body: "체크리스트로 전달 전 완료 항목을 확인합니다.",
      },
    ],
    howToEn: [
      {
        n: "01",
        title: "Requirements",
        body: "Fill the questionnaire to gather project inputs.",
      },
      {
        n: "02",
        title: "Quote & scope",
        body: "Align inclusions with the quotation and scope sheets.",
      },
      {
        n: "03",
        title: "Contract draft",
        body: "Edit the draft when you need a written baseline.",
      },
      {
        n: "04",
        title: "Delivery",
        body: "Use the checklist before handoff.",
      },
    ],
    faqKo: [
      {
        q: "지금 구매할 수 있나요?",
        a: "네. ₩19,000에 구매 문의가 가능합니다. 확인 후 이메일로 파일을 전달합니다.",
      },
      {
        q: "즉시 다운로드되나요?",
        a: "아닙니다. 현재는 구매 문의 확인 후 이메일로 DOCX·PDF를 전달합니다.",
      },
      {
        q: "어떤 파일이 포함되나요?",
        a: "요구사항 질문지, 견적서, 범위서, 계약서 초안, 납품 체크리스트 — 각 DOCX와 PDF입니다.",
      },
      {
        q: "계약서 초안은 법률 문서인가요?",
        a: "실무 참고용 초안입니다. 구체적인 거래와 법률관계에 따라 전문가 검토가 필요할 수 있습니다.",
      },
      {
        q: "다른 사람에게 파일을 공유해도 되나요?",
        a: "원본 파일 재배포·공유·재판매는 허용되지 않습니다. 본인 또는 본인 사업 프로젝트 업무에 수정 사용은 가능합니다.",
      },
    ],
    faqEn: [
      {
        q: "Can I buy this now?",
        a: "Yes. Purchase inquiries are open at ₩19,000. Files are emailed after confirmation.",
      },
      {
        q: "Is there instant download?",
        a: "No. In this version, DOCX and PDF files are emailed after your purchase inquiry is confirmed.",
      },
      {
        q: "What is included?",
        a: "Requirements, quotation, scope of work, contract draft, and delivery checklist — each as DOCX and PDF.",
      },
      {
        q: "Is the contract draft legal advice?",
        a: "No. It is a practical reference draft. Specific deals may need professional legal review.",
      },
      {
        q: "Can I share the original files?",
        a: "No resale, redistribution, or sharing of the original files. You may edit them for your own work or your business projects.",
      },
    ],
    disclaimerKo:
      "본 상품은 실무 문서 템플릿 패키지입니다. 법률 자문·법률 서비스가 아니며, 계약서 초안은 참고용입니다.",
    disclaimerEn:
      "This product is a practical document template pack. It is not legal advice or a legal service. The contract draft is for reference.",
    finalTitleKo: "₩19,000\n구매 문의",
    finalTitleEn: "₩19,000\nPurchase inquiry",
    finalLeadKo: "구매 문의 확인 후 DOCX·PDF를 이메일로 전달합니다.",
    finalLeadEn: "After confirmation, DOCX and PDF files are delivered by email.",
  },
  "app-launch-kit": {
