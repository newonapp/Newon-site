...
const KO_NAV_PATCH = {
  ...
  consumerMenuLabel: "APPS",
  consumerMenuLead: "일상에 필요한 앱과 디지털 제품",
  aiMenuLabel: "AI",
  aiMenuLead: "개인과 기업을 위한 AI 서비스",
  aiExploreCta: "Newon AI 알아보기 →",
  lifeStageMenuLabel: "LivOn",
  lifeStageMenuLead: "생애 단계에 맞는 정보와 서비스",
  lifeStageExploreCta: "LivOn 보기 →",
  lifeStageIntro: "LivOn",
  lifeStageIntroDesc: "삶의 단계마다 필요한 정보와 서비스를 연결합니다",
  lifeStageStart: "LivOn 시작하기",
  lifeStageStartDesc: "LivOn 웹서비스",
  ongilMenuLabel: "ONGIL",
  ongilMenuLead: "시니어 생활과 가족의 연결",
  ongilExploreCta: "Ongil 보기 →",
  ongilIntro: "Ongil",
  ongilIntroDesc: "시니어 생활 지원과 가족과의 연결",
  ongilStart: "Ongil 시작하기",
  ongilStartDesc: "Ongil 웹서비스",
  ...
  bizColSolutions: "솔루션",
  studioBrand: "브랜드",
  studioDigital: "디지털 디자인",
  studioContent: "콘텐츠·캠페인",
  studioIp: "크리에이티브 랩",
  studioCare: "디자인 케어",
  megaMarketDesc: "시장 관찰과 시그널",
};
