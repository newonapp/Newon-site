...
const PATCHES = {
  ja: {
    home: {
      heroEyebrow: "GLOBAL LIFE PLATFORM",
      heroTitleLine1: "アイデアをオンに、",
      heroTitleLine2: "変化を始めます",
      heroTitleAccent: "変化を始めます",
      heroSub: "記録し、管理し、成長するすべての瞬間を。\nNewonのアプリが、より便利な日常をつなぎます。",
      heroDesc: "育児、ペット、健康、目標、家計、サブスク管理まで。\n日常に必要なさまざまなサービスを、ひとつのブランドで。",
  ...
  es: {
    home: {
      ...
      heroTitleLine2: "y empieza el cambio",
      heroTitleAccent: "y empieza el cambio",
      heroSub: "Cada momento que registras, gestionas y creces.\nLas apps de Newon conectan tu día a día.",
      heroDesc: "Crianza, mascotas, salud, metas, finanzas y suscripciones:\ndescubre lo que necesitas en una sola marca.",
  ...
  "pt-br": {
    home: {
      ...
      heroTitleLine2: "e comece a mudança",
      heroTitleAccent: "e comece a mudança",
      heroSub: "Cada momento em que você registra, gerencia e cresce.\nOs apps da Newon conectam o dia a dia.",
      heroDesc: "Parentalidade, pets, saúde, metas, finanças e assinaturas—\nencontre o que precisa em uma só marca.",
  ...
  fr: {
    home: {
      ...
      heroTitleLine2: "et lancez le changement",
      heroTitleAccent: "et lancez le changement",
      heroSub: "Chaque moment où vous notez, gérez et progressez.\nLes apps Newon relient le quotidien.",
      heroDesc: "Parentalité, animaux, santé, objectifs, budget et abonnements—\ntrouvez ce qu’il vous faut sous une même marque.",
  ...
  de: {
    home: {
      ...
      heroTitleLine2: "Wandel beginnen",
      heroTitleAccent: "Wandel beginnen",
      heroSub: "Jeder Moment, in dem du festhältst, organisierst und wächst.\nNewon-Apps verbinden den Alltag.",
      heroDesc: "Elternschaft, Haustiere, Gesundheit, Ziele, Finanzen und Abos—\nalles unter einer Marke.",
  ...
  hi: {
    home: {
      ...
      heroTitleLine2: "बदलाव शुरू करें",
      heroTitleAccent: "बदलाव शुरू करें",
      heroSub: "हर पल जो आप नोट करते, संभालते और बढ़ते हैं।\nNewon के ऐप्स रोज़मर्रा की ज़िंदगी को और आसान बनाते हैं।",
      heroDesc: "पैरेंटिंग, पालतू जानवर, स्वास्थ्य, लक्ष्य, बजट और सदस्यताओं तक—\nएक ही ब्रांड में अपनी ज़रूरत की सेवाएँ खोजें।",
  ...
  id: {
    home: {
      ...
      heroTitleLine2: "mulai perubahan",
      heroTitleAccent: "mulai perubahan",
      heroSub: "Setiap momen Anda mencatat, mengelola, dan tumbuh.\nAplikasi Newon menghubungkan kehidupan sehari-hari.",
      heroDesc: "Dari pengasuhan, hewan peliharaan, kesehatan, target, keuangan, hingga langganan—\ntemukan layanan yang Anda butuhkan dalam satu merek.",
