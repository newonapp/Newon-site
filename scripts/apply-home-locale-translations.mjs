...
const PATCHES = {
  ja: {
    home: {
      ...
      heroDescAreas: "Consumer、AI、LivOn、Ongil、Business、Commerceへと広げ、より良い暮らしのためのひとつのエコシステムをつくります。",
      ...
      heroBizCommerce: "Newon Commerce",
  ...
  es: {
    home: {
      ...
      heroDescAreas: "Expandimos Consumer, AI, LivOn, Ongil, Business y Commerce para construir un ecosistema por una vida mejor.",
  ...
  "pt-br": {
    home: {
      ...
      heroDescAreas: "Expandimos Consumer, AI, LivOn, Ongil, Business e Commerce para construir um ecossistema por uma vida melhor.",
  ...
  fr: {
    home: {
      ...
      heroDescAreas: "Nous élargissons Consumer, AI, LivOn, Ongil, Business et Commerce pour bâtir un écosystème au service d’une vie meilleure.",
  ...
  de: {
    home: {
      ...
      heroDescAreas: "Wir erweitern Consumer, AI, LivOn, Ongil, Business und Commerce — für ein Ökosystem für ein besseres Leben.",
  ...
  hi: {
    home: {
      ...
      heroDescAreas: "Consumer, AI, LivOn, Ongil, Business और Commerce तक विस्तार करते हुए बेहतर जीवन के लिए एक इकोसिस्टम बनाते हैं।",
  ...
  id: {
    home: {
      ...
      heroDescAreas: "Memperluas Consumer, AI, LivOn, Ongil, Business, dan Commerce untuk membangun satu ekosistem bagi kehidupan yang lebih baik.",
