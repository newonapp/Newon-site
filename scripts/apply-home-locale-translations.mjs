...
const PATCHES = {
  ja: {
    home: {
      ...
      heroDescAreas: "Consumer、AI、Livon、Senior、Business、Commerceへと広げ、より良い暮らしのためのひとつのエコシステムをつくります。",
      heroBizAria: "Newonの事業領域",
      heroBizConsumer: "CONSUMER",
      heroBizAi: "AI",
      heroBizLifeStage: "Livon",
  ...
  es: {
    home: {
      ...
      heroDescAreas: "Expandimos Consumer, AI, Livon, Senior, Business y Commerce para construir un ecosistema por una vida mejor.",
  ...
  "pt-br": {
    home: {
      ...
      heroDescAreas: "Expandimos Consumer, AI, Livon, Senior, Business e Commerce para construir um ecossistema por uma vida melhor.",
  ...
  fr: {
    home: {
      ...
      heroDescAreas: "Nous élargissons Consumer, AI, Livon, Senior, Business et Commerce pour bâtir un écosystème au service d’une vie meilleure.",
  ...
  de: {
    home: {
      ...
      heroDescAreas: "Wir erweitern Consumer, AI, Livon, Senior, Business und Commerce — für ein Ökosystem für ein besseres Leben.",
  ...
  hi: {
    home: {
      ...
      heroDescAreas: "Consumer, AI, Livon, Senior, Business और Commerce तक विस्तार करते हुए बेहतर जीवन के लिए एक इकोसिस्टम बनाते हैं।",
  ...
  id: {
    home: {
      ...
      heroDescAreas: "Memperluas Consumer, AI, Livon, Senior, Business, dan Commerce untuk membangun satu ekosistem bagi kehidupan yang lebih baik.",
