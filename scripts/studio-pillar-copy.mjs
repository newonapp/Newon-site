...
const PILLAR_COPY = {
  ...
  care: {
    ko: {
      ...
      metaDescription:
        "이미 있는 브랜드와 화면의 월간 디자인 운영, 일회성 디자인 개선. 둘 다 별도 견적. 개발비는 Business Care.",
      eyebrow: "NEWON STUDIO · DESIGN CARE",
      headline: "만든 다음에도\n디자인을 운영합니다.",
      lead: "보유한 브랜드와 화면을 월 계약으로 운영하거나, 필요한 구간만 한 번 개선합니다.\n코드·기능·서버는 Newon Business Care이며 디자인 견적에 포함되지 않습니다.",
      process: [
      ...
      faq: [
        { q: "지금 바로 월 구독이 되나요?", a: "월 구독 상품이 아닙니다. 정기 작업은 월간 디자인 운영, 한 번의 개선은 기존 디자인 개선으로 각각 견적합니다." },
      ...
      services: [
        {
          ...
          tab: "MONTHLY",
          summary: "월 계약으로 SNS·배너·경미한 수정을 지원. 단발 개선과 견적이 다릅니다.",
          what: "합의된 포맷만 제작. 작업량·수정·납기는 상담 후. 무제한·당일 보장 없음.",
          for: "매달 디자인이 필요하고 사내 디자이너가 없는 팀.",
          included: "요청 관리 · 합의 포맷 제작 · 작업 내역",
          deliverables: "합의 형식의 디자인 파일, 작업 내역",
          timeline: "계약에 따름",
          ready: true,
        },
        {
          ...
          tab: "IMPROVE",
          summary: "기존 디자인의 일회성 개선. 브랜드 유지와 웹·앱 화면도 이 프로젝트입니다.",
          what: "필요한 구간만 수정. 전체 리뉴얼과 코드 반영은 별도입니다.",
          for: "보유한 브랜드·화면의 특정 구간을 한 번 손볼 팀.",
          included: "현황 리뷰 · 개선 범위 · 합의 화면·자산",
          deliverables: "개선 시안, 합의된 디자인 파일",
          timeline: "별도 견적",
          ready: true,
        },
      ],
    ...
    en: {
      seoTitle: "DESIGN CARE | Newon Studio",
      metaDescription:
        "Monthly design support and one-time design improvement for an existing brand or screens. Both are custom quotes. Build is Business Care.",
      eyebrow: "NEWON STUDIO · DESIGN CARE",
      headline: "Keep design running\nafter the first delivery.",
      lead: "Run an existing brand on a monthly contract, or improve one range in a single project.\nCode, features, and servers are Business Care and are not in the design quote.",
      process: [
      ...
      faq: [
        { q: "Can we subscribe today?", a: "Not a monthly subscription. Ongoing work is Monthly Design Support. A single pass is Design Improvement. Each is quoted on its own." },
      ...
      services: [
        {
          title: "MONTHLY DESIGN SUPPORT",
          tab: "MONTHLY",
          summary: "A monthly contract for social, banners, and small edits. Not the one-time improvement quote.",
          what: "Agreed formats only. Volume, revisions, and timing are set in consultation. No unlimited or same-day promise.",
          for: "Teams that need design every month and have no staff designer.",
          included: "Request queue · agreed formats · work log",
          deliverables: "Agreed design files, work log",
        ...
        },
        {
          title: "DESIGN IMPROVEMENT",
          tab: "IMPROVE",
          summary: "A one-time pass on design you already have. Brand upkeep and web/app screens sit here.",
          what: "Only the agreed range. A full redesign and putting files into code are separate.",
          for: "Teams that need one pass on an existing brand or screens.",
          included: "Review · range · agreed screens and assets",
          deliverables: "Improved comps, agreed design files",
          timeline: "Custom quote",
          ready: true,
        },
      ],
